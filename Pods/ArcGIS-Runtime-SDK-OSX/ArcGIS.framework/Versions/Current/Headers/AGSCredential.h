...
/** Supported authentication types.
 @since 10.2
 */
typedef NS_ENUM(NSInteger, AGSAuthenticationType) {
...
/** Supported modes for logging in using OAuth.
 @since 10.2
 */
typedef NS_ENUM(NSInteger, AGSCredentialOAuthMode) {
...
/** The type of authentication needed to access a secured resource. Possibile
 ...
 @li  AGSAuthenticationTypeUnknown
 @li  AGSAuthenticationTypeNone
 @li  AGSAuthenticationTypeToken
 @li  AGSAuthenticationTypeHTTP	
...
/** Returns the  SecIdentityRef that this credential was initialized with (if present)
...
/** Returns an array of  SecIdentityRef objects that can be used to authenticate against
 the specified  NSURLProtectionSpace. Pass nil for the @p protectionSpace to return all identities
 available to the application.
 @param protectionSpace The protection space in which to retrieve identities for.
 @return An array of  SecIdentityRef objects that can be used for client certificate authentication.
 @since 10.2
 */
...
/** Imports the certificate data into the keychain for the running application. This certificate can be
 ...
 @return An  SecIdentityRef object representing the imported data.
 @since 10.2
 */
...
/** Removes an identity and its certificates from the keychain.
 ...
 @return An  OSStatus result code indicating success or failure. See SecBase.h for for possible values.
 @since 10.2
 */
...
/**  A protocol to aid in handling of secured resources.
