...
/** An array of  AGSClosestFacilityResult objects containing an  AGSDirectionsSet 
...
/** Facilities (points) as an array of  AGSGraphic objects. These are only returned when <code>returnFacilities</code> is true.
 @since 10.2
 */
@property (nonatomic, copy, readonly) NSArray *facilities;

/** Incidents (points) as an array of  AGSGraphic objects. These are only returned when <code>returnIncidents</code> is true.
 @since 10.2
 */
@property (nonatomic, copy, readonly) NSArray *incidents;

/** Messages as an array of  AGSNAMessage objects. These are received when the solve is complete. If a closest facility cannot be
...
/** The point barriers as an array of  AGSGraphic objects. They are returned only if <code>returnPointBarriers</code>
...
/** The polygon barriers as an array of   AGSGraphic objects. They are returned only if <code>returnPolygonBarriers</code> 
...
/** The polyline barriers as an array of   AGSGraphic objects. They are returned only if <code>returnPolylineBarriers</code> 
