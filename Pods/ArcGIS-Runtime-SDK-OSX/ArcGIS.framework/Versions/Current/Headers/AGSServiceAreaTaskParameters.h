...
/**  Input parameters for  AGSServiceAreaTask.
 ...
 The default parameters for an  AGSServiceAreaTask can be retrieved by passing  AGSServiceAreaTask
...
/** The set of facilities loaded as network locations during analysis. Can be 
 either an instance of  AGSDataLayer or  AGSFeatureSet.
 @since 10.2
 */
...
/** The set of point barriers loaded as network locations during analysis. Can 
 be either an instance of  AGSDataLayer or  AGSFeatureSet.
 @since 10.2
 */
...
/** The set of polygons barriers loaded as network locations during analysis. 
 Can be either an instance of  AGSDataLayer or  AGSFeatureSet.
 @since 10.2
 */
...
/** If <code>true</code>, point barriers will be returned in the point barriers property of 
  AGSServiceAreaTaskResult. The default value is <code>false</code>.
 @since 10.2
 */
...
/** If <code>true</code>, polygon barriers will be returned in the polygonBarriers 
 property of  AGSServiceAreaTaskResult. The default value is <code>false</code>.
 @since 10.2
 */
...
/** Options for traveling to or from the facility. Default values are defined by 
 the newtork layer. See  AGSNATravelDirection for a list of valid values.
 @since 10.2
 */
...
/**  Arrival or Departure date and time at the facility. For example, if  travelDirection set to AGSNATravelDirectionToFacility,  timeOfDay represents the arrival time at the facility.
 However, if  travelDirection set to AGSNATravelDirectionFromFacility,  timeOfDay represents the departure time from the facility.
