...
/**  Parameters for  AGSClosestFacilityTask.
 
 Instances of this class represent parameters to be used as input to the  AGSClosestFacilityTask.
 
 The default parameters for an  AGSClosestFacilityTask can be retrieved by passing  AGSClosestFacilityTask
...
/** If <code>true</code>, barriers will be returned in the barriers 
 property of the  AGSClosestFacilityTaskResult. Default value is <code>false</code>.
 @since 10.2
 */
@property (nonatomic, assign) BOOL returnPointBarriers;

/** If <code>true</code>, directions will be generated and returned in the 
 directions property of each  AGSClosestFacilityResult. Default
...
/** When <code>true</code>, closest facility routes will be generated and returned 
 in the route property of each  AGSClosestFacilityResult and  AGSClosestFacilityTaskResult. 
...
/** Arrival or Departure date and time. For example, if  travelDirection set to AGSNATravelDirectionToFacility 
 and  timeOfDayUsage set to AGSNATimeOfDayUseAsEndTime and  timeOfDay is set to 8:00 AM, the route(s) built 
...
/** Defines the way  timeOfDay value is used. The default is as defined in the network layer.
 @note This feature is only available for ArcGIS services v10.1 or greater.
 @since 10.2
 */
...
/** Set the facilities to be used in the closest facility operation.
 @param features An array of  AGSGraphic objects representing  features to be used as facilities in the analysis.
 @since 10.2
 */
...
/** Set the layer information for the facilities to be used in the closest
 facility operation.
 @param layerDefinition The  AGSNALayerDefinition containing information about 
...
/** Set the incidents to be used in the closest facility operation.
 @param features An array of  AGSGraphic objects representing features to be used as incidents in the analysis.
 @since 10.2
 */
...
/** Set the point barriers to be used in the solve operation.
 @param features An array of  AGSGraphic objects representing features to be used as point barriers in the analysis.
 @since 10.2
 */
...
/** Set the polyline barriers to be used in the solve operation.
 @param features An array of  AGSGraphic objects representing  features to be used as polyline barriers in the analysis.
 @since 10.2
 */
...
/** Set the polygon barriers to be used in the solve operation.
 @param features An array of  AGSGraphic objects representing  features to be used as polygon barriers in the analysis.
 @since 10.2
 */
