...
/**  A task to find closest facilities around a location.
 ...
 @see oncept{closest-facility-task.htm, Using a Closest Facility Task or greater.
 @see 
 */
...
/** Performs a closest facility operation with the given input parameters.
 ...
 @since 10.2
 @see  [AGSClosestFacilityTaskDelegate closestFacilityTask:operation:didSolveClosestFacilityWithResult:] , method on delegate for success
 @see  [AGSClosestFacilityTaskDelegate closestFacilityTask:operation:didFailSolveWithError:]  , method on delegate for failure
 */
...
/** Retrieves the default closest facility parameters as defined by the service. 
 ...
 @since 10.2
 @see  [AGSClosestFacilityTaskDelegate closestFacilityTask:operation:didRetrieveDefaultClosestFacilityTaskParameters:] , method on delegate for success
 @see  AGSClosestFacilityTaskDelegate# closestFacilityTask:operation:didFailToRetrieveDefaultClosestFacilityTaskParametersWithError: , method on delegate for failure
...
/**  A delegate of  AGSClosestFacilityTask.
 
 A protocol which must be adopted by any class wishing to be notified when 
  AGSClosestFacilityTask completes successfully or encounters an error. An 
 instance of the class must then be set as  [AGSClosestFacilityTask delegate] .
