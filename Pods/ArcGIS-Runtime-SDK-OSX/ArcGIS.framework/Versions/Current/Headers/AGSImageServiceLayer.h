...
/**  A layer based on an ArcGIS Image service.
 
 An instance of this class allows you to display maps from a remote ArcGIS Image Service. For example: http://sampleserver3.arcgisonline.com/ArcGIS/rest/services/World/MODIS/ImageServer
 
 
 */
@interface AGSImageServiceLayer : AGSDynamicLayer <AGSCoding, AGSSecuredResource, AGSLayerCalloutDelegate, AGSHitTestable>
...
/** The IDs of bands which are to be included in the map image. The band IDs are numbered from 0 to
 the  AGSImageServiceInfo @p bandCount property - 1. You can request for
...
/** Specifies the rendering rule for how the requested map image should be rendered. 
 ...
 Refer to the [REST API [documentation](http://resources.arcgis.com/en/help/arcgis-rest-api/index.html //02r3000000rv000000)]
