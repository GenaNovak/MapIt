...
/**  Group of methods to perform calculations on array of geometry objects
 
 This category contains methods of  AGSGeometryServiceTask that perform calculations on an
...
/** Projects the given geometries into a new spatial reference. All geometries 
 must be of the same type -  AGSPoint,  AGSMultipoint,  AGSPolygon, 
  AGSPolyline, or  AGSEnvelope. The delegate is notified when an operation 
...
/** Simplifies the given geometries to make them topologically consistent according
 to their geometry type. All geometries must be of the same type -  AGSPoint,
  AGSMultipoint,  AGSPolygon, or  AGSPolyline. The delegate is notified 
...
/** Calculates an interior point for each  AGSPolygon in the array. These interior 
