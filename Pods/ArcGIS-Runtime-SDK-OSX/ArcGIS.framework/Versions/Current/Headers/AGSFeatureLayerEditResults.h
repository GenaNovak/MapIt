...
/**  Results of feature edit operations.
...
/** The results of @em add operations as an array of  AGSEditResult objects. 
 @since 10.2
 */
@property (nonatomic, copy, readonly) NSArray *addResults;

/** The results of @em update operations as an array of  AGSEditResult objects. 
 @since 10.2
 */
@property (nonatomic, copy, readonly) NSArray *updateResults;

/** The results of @em delete operations as an array of  AGSEditResult objects. 
 @since 10.2
 */
