...
/**  A task to perform geometric operations.
 
 An instance of this class allows you to  perform various frequently used 
 geometric operations using a remote ArcGIS Geometry Service. 
 For example, http://sampleserver3.arcgisonline.com/ArcGIS/rest/services/Geometry/GeometryServer
 ...
 @see 
 @see  AGSGeometryEngine in order to perform geometric operations locally on the device
...
/** Computes pairs of geometries that satisfy the specified spatial relation.  
 ...
 must be of the same type -  AGSPoint,  AGSMultipoint,  AGSPolygon, 
  AGSPolyline, or  AGSEnvelope. The delegate is notified when the operation
 ...
 @note This feature is only available for ArcGIS services v9.3 Service Pack 1 or greater.
 @since 10.2
 */
...
/**  A delegate of  AGSGeometryServiceTask.
 
 A protocol which must be adopted by any class wishing to be notified when 
  AGSGeometryServiceTask completes successfully or encounters an error. An 
 instance of the class must then be set as  [AGSGeometryServiceTask delegate] .
...
/** Tells the delegate that related geometries were paired successfully.
 ...
 @param relations The relations of the input geometries. Each relation is an 
  AGSGeometryRelationship object where @p geometry1 relates to @p geometry2 
