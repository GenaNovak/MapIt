...
/**  An object representing a registered user of the portal or organization. 
 ...
 and create and share content which is organized into Items ( AGSPortalItem). Users can create and 
 join Groups ( AGSPortalGroup) and share items with Groups. This makes the items visible and 
...
/**  Determines if other users can search for this user's name to find content and groups owned by this
 user and to invite this user to join their groups.  Can be @ AGSPortalAccessPrivate,  AGSPortalAccessOrganization, or  AGSPortalAccessPublic. 
...
/** Tells the delegate that the content of the user has been fetched successfully. 
 ...
 @param items The array of  AGSPortalItem that the user is the owner of.
