...
/**  A base class for marker symbols. 
...
/** The offset on the x-axis & y-axis in points, relative to the center of the marker. Default is 0.0
 ...
 For example, consider an  AGSPictureMarkerSymbol using the image of a pushpin.  
...
/** Whether or not the symbol rotates with the map or stays at the same angle with regards to the screen.
 Only supported for for layers using  AGSGraphicsLayerRenderingModeDynamic
 @since 10.2
 */
@property (nonatomic, assign) AGSMarkerSymbolAngleAlignment angleAlignment;
@end
