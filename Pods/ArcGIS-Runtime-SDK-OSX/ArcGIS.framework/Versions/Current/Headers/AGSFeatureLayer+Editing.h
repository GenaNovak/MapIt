...
/** A category on  AGSFeatureLayer containing methods related to editing
...
/** Adds the specified features to the server.
 ...
 @since 10.2 
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didFeatureEditsWithResults:] , method on delegate for success
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didFailFeatureEditsWithError:] , method on delegate for error
 */
-(NSOperation *)addFeatures: (NSArray*)features;

/** Commits changes made to the specified features to the server.
 
 Only applicable if  [AGSFeatureLayer canUpdateFeature:] is  true for each of the 
 specified featrues
...
/** Delete features on the server based on the specified @em OBJECTIDs
 ...
 Only applicable if  [AGSFeatureLayer canDeleteFeature:] is true for each specified feature.
...
/** Deletes features on the server based on the specified query parameters. Only 
 ...
 Only applicable if  [AGSFeatureLayer canDeleteFeature:] is true for each feature specified by the
 parameters.
...
/** A convenience method to add, delete, and update features on the server.
 ...
 Only applicable if  [AGSFeatureLayer canCreate,]  [AGSFeatureLayer canDeleteFeature:,] and  [AGSFeatureLayer canUpdateFeature:]
 permit the edit.
...
/** Add an attachment to the feature specified by @p objectId on the server. Only applicable
 if  [AGSFeatureLayer attachments] property is  <code>true</code> and the feature (to which this 
 attachment belongs) can be edited ( [AGSFeatureLayer canUpdateFeature:).]
 ...
 @return <code>NSOperation</code> that performs the add.
 @since 10.2
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didAttachmentEditsWithResults:] , method on delegate for success
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didFailAttachmentEditsWithError:] , method on delegate for error
...
/** Get information about all attachments that belong to the specified feature.
 ...
 @since 10.2
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didQueryAttachmentInfosWithResults:] , method on delegate for success
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didFailQueryAttachmentInfosWithError:] , method on delegate for error
 */
...
/** Fetch the contents of the specified attachment.
 ...
 @since 10.2.
 @see  [AGSFeatureLayerEditingDelegate featureLayer:operation:didRetrieveAttachmentWithData:] , method on delegate for success
 @see  AGSFeatureLayerEditingDelegate# featureLayer:operation:didFailRetrieveAttachmentWithError: , method on delegate for error
 */
...
/** Tells the delegate that  AGSFeatureLayer successfully completed making the 
 feature edits  (adds, updates, or deletes). It is possible that a subset of the 
 edits failed. You should inspect the provided  AGSFeatureLayerEditResults 
...
/** Tells the delegate that  AGSFeatureLayer encountered an error while making 
...
/** Tells the delegate that  AGSFeatureLayer successfully completed making the 
 ...
 the edits failed. You should inspect the provided  AGSFeatureLayerAttachmentResults 
 object to find out which edits (if any) failed.
...
/** Tells the delegate that  AGSFeatureLayer successfully completed querying 
 attachment metadata.
 @param featureLayer Feature Layer on which the query attachment infos operation 
 was executed.
 @param op The operation that is performing the server request.
 @param attachmentInfos Array of  AGSAttachmentInfo objects returned by the query.
 @since 10.2
 */
