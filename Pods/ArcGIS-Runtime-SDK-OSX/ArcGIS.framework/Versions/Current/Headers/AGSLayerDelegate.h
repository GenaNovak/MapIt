...
/**  A delegate of  AGSLayer.
 
 A protocol which must be adopted by a class wishing to serve as a delegate for 
  AGSLayer. An instance of the class must then be set as  [AGSLayer delegate] .
 
  AGSLayer notifies the delegate whenever the layer is loaded or
 fails to load.
