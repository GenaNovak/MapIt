...
/**  Information relevant to sublcasses of  AGSTiledLayer
 
 This category organizes the  methods that are relevant to subclassing a tiled layer.
 Developer can create custom tiled layers by paying special attention to the methods in this category when subclassing  AGSTiledLayer.
 
 Sub-classes must provide valid values for  [AGSLayer tileInfo,]  [AGSLayer spatialReference,]  [AGSLayer fullEnvelope,] and
  [AGSLayer initialEnvelope] properties. Other properties on  AGSLayer are optional.
