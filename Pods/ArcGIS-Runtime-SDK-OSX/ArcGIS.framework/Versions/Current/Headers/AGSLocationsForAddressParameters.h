...
/** Parameters of  locationForAddresss operation on  AGSLocator
...
/** 
 ...
 The list of address fields for the default locator created using  [AGSLocator locator] are listed in [[this](http://resources.arcgis.com/en/help/arcgis-online-geocoding-rest-api/ /Multiple_input_field_geocoding/02q000000007000000/)] document.
...
/**
 ...
 The list of supported countries and codes for the default locator created using  [AGSLocator locator] are listed in [[this](http://resources.arcgis.com/en/help/arcgis-online-geocoding-rest-api/ /Service_coverage/02q000000005000000/)] document.
 ...
 */
@property (nonatomic, strong) AGSEnvelope *searchExtent;
...
/**
 ...
 The list of fields available for the default locator created using  [AGSLocator locator]  are listed
 in [[this](http://resources.arcgis.com/en/help/arcgis-online-geocoding-rest-api/ /Service_output/02q000000009000000/)] document.
 @since 10.2
 */
