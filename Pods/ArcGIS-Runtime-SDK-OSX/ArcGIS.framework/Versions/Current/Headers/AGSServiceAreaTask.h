...
/**  A task to compute service areas.
 ...
 @see oncept{service-area-task.htm, Using a Service Area Task or greater.
 @see 
 */
...
/** Performs a service area operation with the given input parameters.
 ...
 @since 10.2
 @see  [AGSServiceAreaTaskDelegate serviceAreaTask:operation:didSolveServiceAreaWithResult:] , method on delegate for success
 @see  [AGSServiceAreaTaskDelegate serviceAreaTask:operation:didFailSolveWithError:]  , method on delegate for failure
 */
...
/** Retrieves the default service area parameters. 
 ...
 @since 10.2
 @see  [AGSServiceAreaTaskDelegate serviceAreaTask:operation:didRetrieveDefaultServiceAreaTaskParameters:] , method on delegate for success
 @see  [AGSServiceAreaTaskDelegate serviceAreaTask:operation:didFailToRetrieveDefaultServiceAreaTaskParametersWithError:]  , method on delegate for failure
 */
...
/**  A delegate of  AGSServiceAreaTask.
 
 A protocol which must be adopted by any class wishing to be notified when 
  AGSServiceAreaTask completes successfully or encounters an error. An 
 instance of the class must then be set as  [AGSServiceAreaTask delegate] .
