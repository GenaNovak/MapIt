...
/**  A delegate of the location datasource.
 
 A protocol that must be adopted by any class wishing to be notified when the
 map's location datasource has an update, or is started or stopped. An instance of the class must then be set as  [AGSLocationDisplayDataSource delegate] .
