...
/** Indicates whether or not  AGSCredential objects should be cached automatically.
 By default, credential caching is ON.
 @since 10.2
 */
@property (nonatomic, assign) BOOL shouldAutoCacheCredentials;

/** Removes all  AGSCredential objects from the shared cache.
 @since 10.2
 */
- (void)removeAllCredentials;

/** Set an  AGSCredential in the cache to be used for the given @p url.
 @param credential An  AGSCredential object to put in the cache.
...
/** Retrieves an  AGSCredential from the cache for the given @p url
 @param url The url in which to pair the @p credential. The url can be one of several things:
 @li The full path to a server from an ArcGIS Server.
 @li The full path to a portal, portal item, hosted item.
 @li The url to a portal - http(s)://www.arcgis.com
 @li The url to an ArcGIS Server instance - http(s)://host(:port)/instance
 @return The  AGSCredential from the cache for the given @p serverKey.
 @since 10.2
 */
- (AGSCredential*)credentialForUrl:(NSURL*)url;

/** Removes the associated  AGSCredential from the cache for the given @p url
...
/** Removes a specific  AGSCredential from the cache.
 @param credential The credential in which to remove from the cache.
 @since 10.2
 */
- (void)removeCredential:(AGSCredential*)credential;

/** Returns the default  AGSCredentialCache. This is also a global cache.
 @since 10.2
 */
