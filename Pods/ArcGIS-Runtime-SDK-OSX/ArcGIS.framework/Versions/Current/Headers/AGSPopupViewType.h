...
/** The type of view within  AGSPopupsContainerViewController
 @since 10.2
 */
typedef NS_ENUM(NSInteger, AGSPopupViewType) {
	AGSPopupViewTypeContainer = 0,  /*!< The default starting view */
	AGSPopupViewTypeUIImagePicker,  /*!< View that displays the AGSImagePicker */
