...
/**  A callout window.
 ...
 @extends UIView
 @see oncept{map-callout.htm, Displaying a Callout}
 @see  AGSCalloutDelegate and  AGSLayerCalloutDelegate
 @since 10.2
 */
...
/** The custom view to display in the callout. If this property is specified,
 ...
 to fit the dimensions of the custom view. Most of the other properties related to the look (such as  width, color, etc.) and content
 of the callout (such as  title,  detail,  image,  accessoryButtonImage, etc.) will be ignored.
 @since 10.2
 */
...
/** Flags specifying the possible leader locations when showing the callout. Possible values include:
 ...
 @li  AGSCalloutLeaderPositionLeft
 @li  AGSCalloutLeaderPositionRight
 @li  AGSCalloutLeaderPositionTop
 @li  AGSCalloutLeaderPositionBottom
 @li  AGSCalloutLeaderPositionAny
 
 
 These values can be combined with the bitwise OR operator. The default value
 is   AGSCalloutLeaderPositionBottom .
...
/** Point offset in screen coordinates from the map location that the callout 
 ...
 @since 10.2
 @deprecated Deprecated at 10.2. Use  [AGSCallout screenOffset] instead.
 */
...
/** Moves the callout to the specified map location and screen point offset.
 ...
 @deprecated Deprecated at 10.2. Use  [AGSCallout moveCalloutTo:screenOffset:animated:] instead.
 @since 10.2
 */
...
/** Shows the callout at the specified map location and screen point offset
 ...
 @param pixelOffset The offset from the map location to place the callout in screen points.
 @param animated Flag to determine if action should be animated.
 @deprecated Deprecated at 10.2. Use  [AGSCallout showCalloutAt:screenOffset:animated:] instead.
 @since 10.2
 */
...
/** Show callout at specified location for a specific graphic. If the layer that the graphic belongs to contains a valid calloutDelegate ( [AGSHitTestable calloutDelegate),] it is given an opportunity to display information about the graphic in the callout via  [AGSLayerCalloutDelegate callout:willShowForFeature:layer:mapPoint:]
 Otherwise, the callout's  delegate, if it exists,  is given an opportunity through
 via  [AGSCalloutDelegate callout:willShowForFeature:layer:mapPoint:]
 ...
 @deprecated Deprecated at 10.2. Use  [AGSCallout showCalloutAtPoint:forFeature:animated:] instead.
 @since 10.2
 */
-(void)showCalloutAtPoint:(AGSPoint *)mapPoint forGraphic:(AGSGraphic*)graphic animated:(BOOL)animated __attribute__((deprecated));

/** Show callout at specified location for a specific feature. If the layer that the feature belongs to contains a valid calloutDelegate ( [AGSHitTestable calloutDelegate),] it is given an opportunity to display information about the feature in the callout via  [AGSLayerCalloutDelegate callout:willShowForFeature:layer:mapPoint:]
 Otherwise, the callout's  delegate, if it exists,  is given an opportunity through
  [AGSCalloutDelegate callout:willShowForFeature:layer:mapPoint:]
 @param mapPoint Map point that will be used for the callout. You can pass <code>nil</code>
...
/** Shows the callout for the AGSLocationDisplay on the map.
 The callout's  delegate, if it exists, is given an opportunity to display information in the callout through
  [AGSCalloutDelegate callout:willShowForLocationDisplay:]
 @return Value indicating whether or not the callout did actually show.
 @since 10.2
 */
...
/** Show callout at specified location
 ...
 @param animated
 @deprecated Deprecated at 10.2. Use  [AGSCallout showCalloutAt:screenOffset:rotateOffsetWithMap:animated:] instead.
 @since 10.2
 */
...
/** Move callout to the specified location
 ...
 @param rotateOffsetWithMap
 @param animated
 @deprecated Deprecated at 10.2. Use  [AGSCallout moveCalloutTo:screenOffset:rotateOffsetWithMap:animated:] instead.
 @since 10.2
 */
...
/**  A delegate of  AGSCallout.
 ...
 interacts with the callout window. An instance of the class must be set as  [AGSCallout delegate.]
...
/** Delegates should implement this method when they want to configure how a callout looks for a particular feature in a particular layer.
 ...
 This method will only be called if  [AGSHitTestable calloutDelegate] is not set.
...
/** Tells the delegate the user tapped on the accessory button in the callout.
 You can check the  [AGSCallout representedObject] to find out what object the callout was being displayed for
