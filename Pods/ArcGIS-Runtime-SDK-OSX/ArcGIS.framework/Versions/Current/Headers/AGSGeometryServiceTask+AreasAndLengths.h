...
/**  Group of methods to perform area and length calculations
 
 This category contains methods of  AGSGeometryServiceTask that deal with area and length calculations.
 
 
 */
@interface AGSGeometryServiceTask (AreasAndLengths)

/** Gets the area and length for each  AGSPolygon in the array. The delegate
...
/** Gets the length for each  AGSPolyline in the array. The delegate
 is notified when an operation completes successfully or encounters an error.
