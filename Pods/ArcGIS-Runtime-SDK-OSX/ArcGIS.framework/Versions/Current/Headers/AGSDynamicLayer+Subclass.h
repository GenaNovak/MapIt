...
/**  Information relevant to sublcasses of  AGSDynamicLayer
 
 This category organizes the  methods that are relevant to subclassing a dynamic layer.
 Developer can create custom dynamic layers by paying special attention to the methods in this category when subclassing  AGSDynamicLayer.
 
 Sub-classes must provide valid values for  [AGSLayer spatialReference,]  [AGSLayer fullEnvelope,] and
