...
/**  Input paramters for  AGSRouteTask.
 
 Instances of this class represent input parameters for the  AGSRouteTask. 
 
 The default
 parameters for an  AGSRouteTask can be retrieved by passing  AGSRouteTask
...
/** An array of NSDictionary objects that describe the parameter values. Properties of
 ...
 (Number or String) value			- Parameter value.
 @since 10.2
 */
...
/** The length units to use when computing directions. 
 ...
 @li  AGSNAUnitCentimeters 	
 @li  AGSNAUnitDays 	
 @li  AGSNAUnitDecimalDegrees 	
 @li  AGSNAUnitDecimeters 	
 @li  AGSNAUnitFeet 	
 @li  AGSNAUnitHours 	
 @li  AGSNAUnitInches 	
 @li  AGSNAUnitKilometers 	
 @li  AGSNAUnitMeters 	
 @li  AGSNAUnitMiles 	
 @li  AGSNAUnitMillimeters 	
 @li  AGSNAUnitMinutes 	
 @li  AGSNAUnitNauticalMiles 	
 @li  AGSNAUnitPoints 	
 @li  AGSNAUnitSeconds 	
 @li  AGSNAUnitUnknown 	
 @li  AGSNAUnitYards 
 ...
 */
@property (nonatomic, copy) NSString *directionsTimeAttributeName __attribute__((deprecated));
...
/** If  true, point barriers used in the analysis are returned in the   pointBarriers
 property of  AGSRouteTaskResult. 
 @since 10.2
 */
...
/** If <code>true</code>, directions are generated and returned in the @p directions
 property of each  AGSRouteResult. 
 @since 10.2
 */
@property (nonatomic, assign) BOOL returnDirections;

/** If  true, polygon barriers used in the analysis are returned in the   pointBarriers
 property of  AGSRouteTaskResult
 @since 10.2
 */
@property (nonatomic, assign) BOOL returnPolygonBarriers;

/** If  true, polyline barriers used in the analysis are returned in the   pointBarriers
 property of  AGSRouteTaskResult
 @since 10.2
 */
...
/** If <code>true</code>, time windows should be used in the analysis. 
 Not supported for local route task.
 Default is NO.
 @since 10.2
 */
...
/** Defines content, verbosity of returned directions. The default is AGSNADirectionsOutputTypeStandard.
 ...
 @deprecated Deprecated at 10.2. No replacement.
 */
@property (nonatomic, assign) AGSNADirectionsOutputType directionsOutputType __attribute__((deprecated));
...
/** Set the layer information for the polyline barriers to be used in the solve 
 operation. Not supported by local task.
 @param layerDefinition The  AGSNALayerDefinition containing information about 
