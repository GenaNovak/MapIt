...
/**  A layer based on a tile package
 ...
 @see oncept{local-tiled-layer.htm, Using a local tiled layer}
 @see 
 */
@interface AGSLocalTiledLayer : AGSTiledLayer

/** The full path to the tile package on disk, including the ".tpk" file extension.
 @since 10.2
 */
...
/** An array of  AGSLocalTiledSubLayerInfo objects representing the layers within this layer. 
