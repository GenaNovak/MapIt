...
/**  A task to perform structured queries.
 ...
 @see oncept{query-task.htm, Using a Query Task}
 @see 
 */
...
/** Layer info used when querying a @C AGSSDynamicMapServiceLayer.  Use
 queryTaskWithURL:dynamicLayerInfo or queryTaskWithURL:dynamicLayerInfo:credential
 to specify the layer to be used when querying a dynamic map service layer.
 @since 10.2.4
 */
@property (nonatomic, strong, readonly) AGSDynamicLayerInfo *dynamicLayerInfo;

/** Initialize an autoreleased query task.
 @param url URL to a layer resource in the ArcGIS Server REST Services Directory.
 @return A new query task object.
 @since 10.2
 */
...
/** Initialize an autoreleased query task.  Note that the URL used when using a dynamicLayerInfo
 represents the dynamic map service (example: http://sampleserver6.arcgisonline.com/arcgis/rest/services/Census/MapServer)
 and not a layer resource as in the non-dynamicLayerInfo methods.
 @param url URL to a dynamic map service resource in the ArcGIS Server REST Services Directory.
 @param dynamicLayerInfo dynamic layer info specifying the layer to query.
 @return A new query task object.
 @since 10.2.4
 */
+ (id)queryTaskWithURL:(NSURL *)url dynamicLayerInfo:(AGSDynamicLayerInfo *)dynamicLayerInfo;
...
/** Initialize an autoreleased query task.  Note that the URL used when using a dynamicLayerInfo
 ...
 @since 10.2.4
 */
+ (id)queryTaskWithURL:(NSURL *)url dynamicLayerInfo:(AGSDynamicLayerInfo *)dynamicLayerInfo credential:(AGSCredential*)cred;
...
/** Executes a query against the layer resource pointed by the <code>url</code>.
 ...
 @since 10.2
 @see  [AGSQueryTaskDelegate queryTask:operation:didExecuteWithFeatureSetResult:] , method on delegate for success
 @see  [AGSQueryTaskDelegate queryTask:operation:didFailWithError:]  , method on delegate for failure
 */
...
/** Executes a query against the layer resource pointed by the <code>url</code>.
 ...
 @see  [AGSQueryTaskDelegate queryTask:operation:didExecuteWithObjectIds:] , method on delegate for success
 @see  [AGSQueryTaskDelegate queryTask:operation:didFailQueryForIdsWithError:] , method on delegate for failure
 */
...
/** Executes a query against the layer resource pointed by the <code>url</code>.
 ...
 @note This feature is only available for ArcGIS services v10 or greater.
 @see  [AGSQueryTaskDelegate queryTask:operation:didExecuteWithRelatedFeatures:] , method on delegate for success
 @see  [AGSQueryTaskDelegate queryTask:operation:didFailRelationshipQueryWithError:] , method on delegate for failure
 */
...
/** Executes a query against the layer resource pointed by the <code>url</code>.
 ...
 @note This feature is only available for ArcGIS services v10 or greater.
 @see  [AGSQueryTaskDelegate queryTask:operation:didExecuteWithFeatureCount:] , method on delegate for success
 @see  [AGSQueryTaskDelegate queryTask:operation:didFailQueryFeatureCountWithError:] , method on delegate for failure
 */
...
/**  A delegate of  AGSQueryTask.
 
 A protocol which must be adopted by any class wishing to be notified when the 
  AGSQueryTask completes successfully or encounters an error. An instance of 
 the class must then be set as  [AGSQueryTask delegate] .
...
@optional
/** Tells the delegate that  AGSQueryTask completed successfully with the 
 provided results.
...
/** Tells the delegate that  AGSQueryTask completed query for IDs successfully 
...
/** Tells the delegate that  AGSQueryTask encountered an error while performing 
 query for IDs.
 @param queryTask The task which performed the query.
 @param op <code>NSOperation</code> that performed the query task.
 @param error Information about the error returned by the service.
...
/** Tells the delegate that  AGSQueryTask completed query for related features 
 successfully with the provided results.
 
 The related features are returned as a dictionary of key-value pairs.
 Keys contain <code>NSNumber</code> objects representing IDs from  AGSRelationshipQuery 
 <code>objectIds</code>. Values contain arrays of  AGSFeatureSet objects representing the 
...
/** Tells the delegate that  AGSQueryTask completed query with feature count 
 successfully.
 @param queryTask The task which performed the query.
 @param op <code>NSOperation</code> that performed the query task.
