...
/**  A layer based on an OGC-WMS map service.
 
 An instance of this class allows you to display maps from an OGC compliant WMS map service. For example, http://lasigpublic.nerc-lancaster.ac.uk/ArcGIS/services/Biodiversity/CSHedges/MapServer/WMSServer
...
/** A list of  AGSWMSLayerInfo objects, which contain the name, title, and extent
 of each subLayer.
 @since 10.2
 */
...
/** The sub-layers to be included in the map image exported by the map service. 
 ...
 an array containing the names of each  AGSWMSLayerInfo that needs to
