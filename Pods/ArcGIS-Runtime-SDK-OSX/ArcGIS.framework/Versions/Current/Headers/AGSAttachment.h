...
@since 10.2
*/
typedef NS_ENUM(NSInteger, AGSAttachmentEditState) {
...
/**  An attachment belonging to a feature
 
 Instances of this class represent an attachment on the client. This is
 used with the  AGSAttachmentManager. This class automatically saves the attachment data
 ...
 file is cleaned up when the  AGSAttachmentManager that is managing this attachment is cleared.
 @since 10.2
 */
