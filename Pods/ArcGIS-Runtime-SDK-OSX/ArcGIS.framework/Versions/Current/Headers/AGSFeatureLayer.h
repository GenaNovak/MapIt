...
/** Supported modes in which  AGSFeatureLayer fetches features from the server.
 @since 10.2
 */
typedef NS_ENUM(NSInteger, AGSFeatureLayerMode) {
    AGSFeatureLayerModeSnapshot = 0,	/*!< Features are fetched only once; when the layer is first displayed in a map. All features that fall within the map's viewable extent at that time are fetched. More features are not fetched even if you navigate the map subsequently, or even if you hit the max. feature limit on the service. */
    AGSFeatureLayerModeOnDemand,		/*!< Features are fetched when needed as you navigate the map.*/
	AGSFeatureLayerModeSelection		/*!< Features are fetched only when they are selected. See @c AGSFeatureLayer#selectFeaturesWithQuery:selectionMethod: */
} ;

/** Supported modes for selecting features through  AGSFeatureLayer.
 @since 10.2
 */
typedef NS_ENUM(NSInteger, AGSFeatureLayerSelectionMethod) {
...
/**  A layer based on an ArcGIS Server map/feature service layer.
 ...
 features are then held on the device and drawn much like  AGSGraphicsLayer does.
 ...
 <h3>Notifications</h3>
 The layer posts  AGSFeatureLayerDidLoadFeaturesNotification when it finishes loading features
 from a remote feature service.
 
 @see oncept{feature-layer.htm, ArcGIS Feature Layer}
 @see 
 */
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
@interface AGSFeatureLayer : AGSGraphicsLayer <AGSCoding, AGSInfoTemplateDelegate, AGSSecuredResource, AGSGDBFeatureSourceInfo, AGSLayerCalloutDelegate>
...
/** Mode in which the layer retrieves features from the service. Possible modes 
 include
 @li  AGSFeatureLayerModeSnapshot
 @li  AGSFeatureLayerModeOnDemand
 @li  AGSFeatureLayerModeSelection
...
/** The fields available in the layer as defined by the service. The property is an
 array of  AGSField objects. Attributes of features belonging to this layer 
...
/** Collection of  AGSRelationship objects that describe this layer's 
...
/** This is an easy way to set the info template delegate for all graphics in the 
 ...
 <code>nil</code>.
 @deprecated Deprecated at 10.2. Use  [AGSHitTestable calloutDelegate] instead.
 @since 10.2
 */
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
...
/** Indicates whether the layer allows a feature to be updated.
 ...
 It only provides general information about whether the layer is capable of allowing feature updates at all.
 @since 10.2
 */
...
/** Indicates whether the layer allows features to be deleted.
 ...
 It only provides general information about whether the layer is capable of allowing feature deletions at all.
 @since 10.2
 @see canDeleteFeature:
 */
@property (nonatomic, assign, readonly) BOOL canDelete;

/** Indicates whether the layer should use advanced symbols from the service.
 ...
 @since 10.2.2
 */
@property (nonatomic, assign) BOOL advancedSymbols;
...
/** A way to get an initialized layer that does not work with an ArcGIS Server map or feature service, but instead
 ...
 It can also be retrieved from an existing feature layer using  encodeToJSON
 @param featureSetJSON JSON representation of an  AGSFeatureSet containing the features to be displayed by the layer
 @since 10.2
 */
...
/** Executes a query against the service layer pointed by the URL. The query 
 ...
 @since 10.2
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didQueryFeaturesWithFeatureSet:] , method on queryDelegate for success
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didFailQueryFeaturesWithError:]  , method on queryDelegate for failure
 */
...
/** Executes a query against the service layer pointed by the URL. The query 
 ...
 @return The operation performing the query.
 @since 10.2
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didQueryObjectIdsWithResults:] , method on queryDelegate for success
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didFailQueryObjectIdsWithError:] , method on queryDelegate for failure
 */
...
/** Executes a query against the service layer pointed by the URL. The query 
 ...
 @return The operation performing the query.
 @since 10.2
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didQueryFeatureCountWithResult:] , method on  queryDelegate for success
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didFailQueryFeatureCountWithError:] , method on  queryDelegate for failure
*/
...
/**Executes a query against the service layer pointed by the URL. The query 
 ...
 @return The operation performing the query.
 @since 10.2
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didQueryRelatedFeaturesWithResults:] , method on  queryDelegate for success
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didFailQueryRelatedFeaturesWithError:] , method on  queryDelegate for failure
 */
...
/** Selects features based on the specified query. Selected features are 
 ...
 renderer along with a surrounding halo of selectionColor.
 ...
 include
 @li  AGSFeatureLayerSelectionMethodAdd 
 @li  AGSFeatureLayerSelectionMethodNew
 @li  AGSFeatureLayerSelectionMethodSubtract
 
 @return The operation performing the selection.
 
 @since 10.2
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didSelectFeaturesWithFeatureSet:] , method on  queryDelegate for success
 @see  [AGSFeatureLayerQueryDelegate featureLayer:operation:didFailSelectFeaturesWithError:] , method on  queryDelegate for failure
 @see  [AGSGraphicsLayer selectedFeatures] for a list of currently selected features
 @see  selectionColor  selectionSymbol for changing how selected features are displayed
 @see  [AGSFeatureLayer clearSelection] to clear selection
 */
...
/**
 ...
 @since 10.2
 @deprecated Deprecated at 10.1.1. Use  [AGSFeatureLayer setSelected:forGraphic:] instead.
 */
...
/** A convenience method to lookup a feature in the graphics collection using 
 ...
 @return  AGSGraphic object corresponding to @p objectId.
 @since 10.2
 */
...
/** Convenience method to find the feature template associated with a particular feature.
 ...
 @return  AGSFeatureTemplate object that the feature matches.
 @since 10.2
 */
...
/** Convenience method to find a field with a specified name.
 ...
 @return  AGSField object with specified name.
 @since 10.2
 */
...
/**  A delegate of  AGSFeatureLayer.
 
 A protocol which must be adopted by any class wishing to be notified when query 
 operations performed by  AGSFeatureLayer complete successfully or encounter an 
 error.
 An instance of the class must then be set as
  [AGSFeatureLayer queryDelegate] .
...
@optional
/** Tells the delegate that  AGSFeatureLayer completed the query successfully 
...
/**  Tells the delegate that  AGSFeatureLayer encountered an error while 
...
/** Tells the delegate that  AGSFeatureLayer completed query for IDs successfully 
 with the provided results.
 @param featureLayer The feature layer which performed the query.
 @param op The operation that performed the query.
...
/** Tells the delegate that  AGSFeatureLayer completed query for feature count successfully 
 with the provided results.
 @param featureLayer The feature layer which performed the query.
 @param op The operation that performed the query.
...
/** Tells the delegate that  AGSFeatureLayer completed query for related features 
 ...
 IDs from  AGSRelationshipQuery. Values are  AGSFeatureSet objects 
...
/** Tells the delegate that  AGSFeatureLayer encountered an error while performing 
...
/** Tells the delegate that  AGSFeatureLayer successfully selected the given 
 features.
...
/** Tells the delegate that  AGSFeatureLayer encountered an error while try to 
 select features.
 @param featureLayer The feature layer which performed the selection.
 @param op The operation that performed the selection.
 @param error Information about the error that was encountered.
