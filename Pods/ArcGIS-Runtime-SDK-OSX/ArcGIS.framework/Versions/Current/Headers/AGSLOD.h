...
/**  A scale level of a cached map service.
...
/** Resolution, in map units, of each pixel in a tile for the scale level.
 @since 10.2
 @see  [AGSTiledLayer convertedResolutionForLodResolution:] to convert LOD resolution to map resolution.
 @see  [AGSMapView zoomToResolution:animated:]
 */
@property (nonatomic, readonly) double resolution;

/** Scale for the level.
 @since 10.2
 @see  [AGSTiledLayer convertedScaleForLodScale:] to convert LOD scale to map scale.
 @see  [AGSMapView zoomToScale:animated:]
 */
