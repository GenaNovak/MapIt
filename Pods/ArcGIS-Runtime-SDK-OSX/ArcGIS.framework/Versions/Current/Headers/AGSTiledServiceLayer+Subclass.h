...
/**  Information relevant to sublcasses of  AGSTiledServiceLayer
 
 This category organizes the  methods that are relevant to subclassing a tiled service layer.
 Developer can create custom tiled service layers by paying special attention to the methods in this category when subclassing  AGSTiledServiceLayer.
