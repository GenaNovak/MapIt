...
/**  A dictionary renderer object.
 ...
 If the map is outside  labelMaxScale /  labelMinScale, the labels will not display, even if  labelsVisible is true.
 If the map is within  labelMaxScale/  labelMinScale, then the labels will display, unless  labelsVisible is false.
 @since 10.2
 */
