...
/** Fetches the users and admins of the group. When completed, the admins and users properties
 will have requested information. The corresponding methods on  AGSPortalGroupDelegate are invoked when the operation completes successfully or encounters an error.
 @since 10.2
 */
...
/** Tells the delegate that the fetch operation of the group's users and admins completed successfully. 
 ...
 @param op The operation that performed the fetch. 
 @param users Array of all the users ( AGSPortalUser) of the group.
 @param admins Array of all the admin users ( AGSPortalUser) of the group.
 @since 10.2
 */
